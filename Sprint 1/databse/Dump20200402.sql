...
--
-- Host: 127.0.0.1    Database: onlinemarket
-- ------------------------------------------------------
...
LOCK TABLES `storeowner` WRITE;
/*!40000 ALTER TABLE `storeowner` DISABLE KEYS */;
/*!40000 ALTER TABLE `storeowner` ENABLE KEYS */;
UNLOCK TABLES;
...
INSERT INTO `user` VALUES (11,'you','youssef','1234','normaluser'),(21,'haa','mohamed','5478','admin');
...
-- Dump completed on 2020-04-02 21:13:05
